      subroutine n2qn1a (simul,simext, n,x,f,ga,scale,acc,
...
c         call simul(indic,n,x,f,g,izs,rzs,dzs)
          call simul(indic,simext,n,x,f,g,izs,dzs)
c
...
c                recherche lineaire
  ...
  574 romin = dmax1(romin,dabs(z/scale(i)))
      romin=1.d0/romin
c     modif NumX
c     call nlis0(n,simul,fuclid,x,f,dga,ro,romin,romax,d,g,
      call nlis0(n,simul,simext,fuclid,x,f,dga,ro,romin,romax,d,g,
...
c                ici,tout est termine
  900 if(mode.ne.5.and.mode.ne.3.and.mode.ge.0) go to 910
      indic=4
c       ****** modif NumX ****      
c     call simul(indic,n,x,f,ga,izs,rzs,dzs)
      call simul(indic,simext,n,x,f,ga,izs,dzs)
  910 iz(1)=nr
