...
c
c------------------------------------------------------------------------
      SUBROUTINE rnlsbs ( simext, mxpar, xini, binf, bsup,
     &                    nfct, moyobs, covobs,
...
c     external functions
      EXTERNAL simext, simrnlss, inirnls, YV, PMX, YVI, bfgsboxs
c
c     arguments i/o
     ...
     &                 matsmo(*), covobs(nfct,*), dudata(*), xpar(*)
c
c     workspaces
      INTEGER iwork(*)
...
c     initialization of lambda > eigmax + epsilon
      dwork(pxopt+mxpar) = inilam*eigmax
c
